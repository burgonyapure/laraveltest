...
<script>
    ...
    /* **************************
       ...
       ************************** */
    function main() {
        document.getElementById("score_text").innerHTML = "Pont: " + parseInt((score - time_taken/10), 10);

        if (total_balls_eaten === 61) {
            win_or_lose_text.innerHTML = "Nyertél";
        }
        else if (eaten_by_ghosts === true) {
            win_or_lose_text.innerHTML = "Vesztettél";
        }
        else {
            /* **************************
                    START OF PLAYER
